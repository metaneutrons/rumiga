...
pub fn asm(dir: Direction, am: AddressingMode) -> Vec<u16> {
    assert!(
        ...
        "Invalid direction field in ASm assembler: expected left or right, got {dir:?}"
    );
    assert!(
        am.verify(&MODES_234567, &[0, 1]),
...
pub fn asr(count_reg: u16, dir: Direction, size: Size, reg_shift: bool, reg: u16) -> u16 {
    assert!(
        count_reg <= 7,
        "Invalid count/register field in ASr assembler: expected 0 to 7, got {count_reg}"
    );
    assert!(
        dir == Direction::Left || dir == Direction::Right,
        "Invalid direction field in ASr assembler: expected left or right, got {dir:?}"
    );
    assert!(
        reg <= 7,
        "Invalid register field in ASr assembler: expected 0 to 7, got {reg}"
    );
...
pub fn bchg_dynamic(reg: u8, am: AddressingMode) -> Vec<u16> {
    assert!(
        reg <= 7,
        "Invalid register field in BCHG dynamic assembler: expected 0 to 7, got {reg}"
    );
    assert!(
        am.verify(&MODES_0234567, &[0, 1]),
...
pub fn bclr_dynamic(reg: u8, am: AddressingMode) -> Vec<u16> {
    assert!(
        reg <= 7,
        "Invalid register field in BCLR dynamic assembler: expected 0 to 7, got {reg}"
    );
    assert!(
        am.verify(&MODES_0234567, &[0, 1]),
...
pub fn bset_dynamic(reg: u8, am: AddressingMode) -> Vec<u16> {
    assert!(
        reg <= 7,
        "Invalid register field in BSET dynamic assembler: expected 0 to 7, got {reg}"
    );
    assert!(
        am.verify(&MODES_0234567, &[0, 1]),
...
pub fn btst_dynamic(reg: u8, am: AddressingMode) -> Vec<u16> {
    assert!(
        reg <= 7,
        "Invalid register field in BTST dynamic assembler: expected 0 to 7, got {reg}"
    );
    assert!(
        am.verify(&MODES_0234567, &[0, 1, 2, 3, 4]),
...
pub fn chk(reg: u8, am: AddressingMode) -> Vec<u16> {
    assert!(
        reg <= 7,
        "Invalid register field in CHK assembler: expected 0 to 7, got {reg}"
    );
    assert!(
        am.verify(&MODES_0234567, &[0, 1, 2, 3, 4]),
...
pub fn divs(reg: u8, am: AddressingMode) -> Vec<u16> {
    assert!(
        reg <= 7,
        "Invalid register field in DIVS assembler: expected 0 to 7, got {reg}"
    );
    assert!(
        am.verify(&MODES_0234567, &[0, 1, 2, 3, 4]),
...
pub fn divu(reg: u8, am: AddressingMode) -> Vec<u16> {
    assert!(
        reg <= 7,
        "Invalid register field in DIVU assembler: expected 0 to 7, got {reg}"
    );
    assert!(
        am.verify(&MODES_0234567, &[0, 1, 2, 3, 4]),
...
pub fn lea(reg: u8, am: AddressingMode) -> Vec<u16> {
    assert!(
        reg <= 7,
        "Invalid register field in LEA assembler: expected 0 to 7, got {reg}"
    );
    assert!(
        am.verify(&MODES_2567, &[0, 1, 2, 3]),
...
pub fn lsm(dir: Direction, am: AddressingMode) -> Vec<u16> {
    assert!(
        dir == Direction::Left || dir == Direction::Right,
        "Invalid direction field in LSm assembler: expected left or right, got {dir:?}"
    );
    assert!(
        am.verify(&MODES_234567, &[0, 1]),
...
pub fn lsr(count_reg: u16, dir: Direction, size: Size, reg_shift: bool, reg: u16) -> u16 {
    assert!(
        count_reg <= 7,
        "Invalid count/register field in LSr assembler: expected 0 to 7, got {count_reg}"
    );
    assert!(
        dir == Direction::Left || dir == Direction::Right,
        "Invalid direction field in LSr assembler: expected left or right, got {dir:?}"
    );
    assert!(
        reg <= 7,
        "Invalid register field in LSr assembler: expected 0 to 7, got {reg}"
    );
...
pub fn muls(reg: u8, am: AddressingMode) -> Vec<u16> {
    assert!(
        reg <= 7,
        "Invalid register field in MULS assembler: expected 0 to 7, got {reg}"
    );
    assert!(
        am.verify(&MODES_0234567, &[0, 1, 2, 3, 4]),
...
pub fn mulu(reg: u8, am: AddressingMode) -> Vec<u16> {
    assert!(
        reg <= 7,
        "Invalid register field in MULU assembler: expected 0 to 7, got {reg}"
    );
    assert!(
        am.verify(&MODES_0234567, &[0, 1, 2, 3, 4]),
...
pub fn rom(dir: Direction, am: AddressingMode) -> Vec<u16> {
    assert!(
        dir == Direction::Left || dir == Direction::Right,
        "Invalid direction field in ROm assembler: expected left or right, got {dir:?}"
    );
    assert!(
        am.verify(&MODES_234567, &[0, 1]),
...
pub fn ror(count_reg: u16, dir: Direction, size: Size, reg_shift: bool, reg: u16) -> u16 {
    assert!(
        count_reg <= 7,
        "Invalid count/register field in ROr assembler: expected 0 to 7, got {count_reg}"
    );
    assert!(
        dir == Direction::Left || dir == Direction::Right,
        "Invalid direction field in ROr assembler: expected left or right, got {dir:?}"
    );
    assert!(
        reg <= 7,
        "Invalid register field in ROr assembler: expected 0 to 7, got {reg}"
    );
...
pub fn roxm(dir: Direction, am: AddressingMode) -> Vec<u16> {
    assert!(
        dir == Direction::Left || dir == Direction::Right,
        "Invalid direction field in ROXm assembler: expected left or right, got {dir:?}"
    );
    assert!(
        am.verify(&MODES_234567, &[0, 1]),
...
pub fn roxr(count_reg: u16, dir: Direction, size: Size, reg_shift: bool, reg: u16) -> u16 {
    assert!(
        count_reg <= 7,
        "Invalid count/register field in ROXr assembler: expected 0 to 7, got {count_reg}"
    );
    assert!(
        dir == Direction::Left || dir == Direction::Right,
        "Invalid direction field in ROXr assembler: expected left or right, got {dir:?}"
    );
    assert!(
        reg <= 7,
        "Invalid register field in ROXr assembler: expected 0 to 7, got {reg}"
    );
